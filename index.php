...
<!-- Hidden on desktop & shown on mobile -->
  <div class="navbar-collapse offcanvas-collapse" id="navbarsExampleDefault">
    <ul class="navbar-nav mr-auto d-sm-block d-md-none">
      ...
      <li class="nav-item"><a class="nav-link" href="http://bit.ly/sound" target="_blank">Soundcloud</a></li>
...
<div class="nav-scroller bg-white box-shadow d-none d-md-block">
  <nav class="nav nav-underline">
    ...
    <a class="nav-link" href="http://bit.ly/sound" target="_blank">Soundcloud</a>
...
<main role="main" class="container">
  <div class="d-flex align-items-center p-3 my-3 rounded" style="background: url('image/banner-bg.jpg') repeat-x;">
    ...
    <h3 class="logo">Raveon</h3><img src="image/Raveon-logo-web.svg" width="100" alt="Raveon">
  </div>
